...
class UserCommand extends CommandBase {
    ...
    public function execute(User $user, array $args): void {
        ...
        if ($user->isRegistered()) {
            // Only send welcome messages if capability negotiation is not in progress
            if (!$user->isCapabilityNegotiationInProgress()) {
                $this->sendWelcomeMessage($user);
            }
            // If capability negotiation is in progress, welcome messages will be sent after CAP END
        }
    }
